...
class SubRegionalAwardsHandler (Handler):
    def __init__(self):
        ...
        self.animationSpeed = 2500.0 # 50000.0
        ...
        self.ffTimer = Timer()
        self.ffMode = True # False
        #self.ffLength = 300000.0 #velocidade do relogio no ffMode (diminua para deixar mais rapido)
        self.ffLength = 10000.0 #velocidade do relogio no ffMode (diminua para deixar mais rapido)
    ...
    def draw_header(self):
        ...
        time_string = "%d minutos" % (Handler.contest.contestTime)
